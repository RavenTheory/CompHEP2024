...
//THE FOLLOWING CODE IS THE MODIFICATION DONE TO THE PROGRAM SO THAT IT ALSO CALCULATES THE TOTAL WIDTH OF THE SM HIGGS
  complex<double> couplingS[ncouplings], couplingsmS[ncouplingsms];
  RealType gammas[ngammas], gammasms[ngammasms];
  int fast;
  FHCouplings(&error, couplingS, couplingsmS, gammas, gammasms, fast);
  cout << "Gamma = " << GammaSMTot(3) <<endl;
